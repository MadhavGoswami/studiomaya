...
>
  ...
  {isTeamCardOpen && (
    ...
    >
      <motion.div
        className="relative bg-white p-4 sm:p-6 md:p-8 lg:p-10 shadow-lg rounded-lg w-[95%] sm:w-[90%] md:w-4/5 lg:w-3/4 max-h-screen overflow-hidden"
        onClick={(e) => e.stopPropagation()}
        initial={{ scale: 0.9, opacity: 0 }}
        animate={{ scale: 1, opacity: 1 }}
        exit={{ scale: 0.9, opacity: 0 }}
      ...
      >
        ...
        {/* Updated Grid for Mobile and Desktop */}
